...
import { letters, updateLetter, playState, playEasing, playDuration, playDirection } from './stores';
...
$: style = `
	...
	${$playState ? `animation: a-${letterObj.id} ${$playDuration}s infinite ${$playDirection} ${$playEasing};` : ''}
`;
